    ...
    <div class="header-content-2">
        <div class="links">
            <ul class="nav-container">
                <li class="sistema nav-link"><a href="">Explorar</a></li>
                <li class="sistema nav-link"><a href="">Crear</a></li>
                <li class="sistema nav-link"><a href="">Tiendas</a></li>
                <li class="sistema nav-link"><a href="">Productos</a></li>
            </ul>
        </div>
        <div class="search">
