...
<head>
    ...
    <link rel="stylesheet" href="https://nintaisquare.com/sources/assets/styles/root.css">
    <link rel="stylesheet" href="https://nintaisquare.com/sources/assets/styles/support.css">
    <link rel="icon" type="image/x-icon" href="https://nintaisquare.com/sources/assets/img/favicon-support.png">
</head>
<body>
    <div class="container">
        <?php
            ...
            <div class="user">
                <?php
                    if (!isset($_SESSION["USER_AUTH"])) { ?>
                        <a href="https://nintaisquare.com/user/signin.php" class="login" target="_blank"><i class="fa-solid fa-right-to-bracket"></i>Iniciar sesión</a>
                    <?php } else { ?>
